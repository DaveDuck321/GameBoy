...
std::array<std::array<int, 3>, 5> colorsRGB{{{{236, 247, 207}},
                                             {{145, 204, 120}},
                                             {{47, 116, 86}},
                                             {{8, 24, 28}},
                                             {{255, 0, 0}}}};
...
NSPIRE_SDL::~NSPIRE_SDL() { SDL_Quit(); }
...
void NSPIRE_SDL::drawPixel(int color, int screenX, int screenY) const {
  ...
  SDL_FillRect(screen, &rect,
               SDL_MapRGB(screen->format, colorsRGB[color][0],
                          colorsRGB[color][1], colorsRGB[color][2]));
}
